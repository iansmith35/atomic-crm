...
export default function MailroomOffice() {
  ...
  useEffect(() => {
    async function fetchTasks() {
      const res = await fetch("/api/tasks?office=mailroom");
  ...
  return (
    <div className="p-6 max-w-6xl mx-auto">
      <h1 className="text-2xl font-bold mb-4">📨 Admin Mailroom</h1>

      <section>
        <h2 className="text-lg font-semibold mb-2">Taskbar – Mailing Only</h2>
