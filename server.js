...
app.listen(PORT, () => {
  ...
  console.log(`💬 Chat API available at http://localhost:${PORT}/api/chat/messages`);
  console.log(`📋 Tasks API available at http://localhost:${PORT}/api/tasks`);
  console.log(`🤖 AI Chat API available at http://localhost:${PORT}/api/ai/chat`);
  console.log(`⚙️ Config API available at http://localhost:${PORT}/api/config`);
